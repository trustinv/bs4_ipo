...
class CompanyInfoGeneral(Base):
    ...
    ci_logo:str = Column(String(255), comment="로고이미지")
    ci_logo_name:str = Column(String(255), comment="로고이미지 파일명")
    ci_keyword1:str = Column(String(255), comment="키워드1(앱)")
    ci_keyword2:str = Column(String(255), comment="키워드2(앱)")
    ci_keyword3:str = Column(String(255), comment="키워드3(앱)")
    ci_keyword4:str = Column(String(255), comment="키워드4(앱)")
    ...
    ci_comment:str = Column(Text, comment="1~2줄 코멘트")
    ...
    ci_appraised_price:int = Column(INTEGER(11), comment="주당평가액")
    ...
    ci_attractiveness:str = Column(String(255))
    ci_attractiveness_name:str = Column(String(255))
    ci_attractiveness_score:int = Column(INTEGER(11))
    ...
    ci_noted_items:str = Column(Text, comment="참고사항")
    ci_noted_items_check:str = Column(String(50), comment="참고사항 활성화 (N:비활성화 , Y:활성화)")
    ci_guidelines:str = Column(Text, comment="안내사항")
    ...
    ci_promise_content:str = Column(Text, comment="의무보유확약내용")
    ci_promise_rate:float = Column(Float(asdecimal=True), comment="의무보유확약비율")
...
class CompanyInfoFinancial(Base):
    ...
    ci_eps:float = Column(Float(asdecimal=True), comment="기본주당이익")
    ci_datetime:datetime = Column(DateTime, server_default=text("'0000-00-00 00:00:00'"))
